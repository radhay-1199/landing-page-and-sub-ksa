...
<div class="container-fluid back">
		<div class="langDropdown" dir="ltr">
            ...
            <h1 class="logo"><spring:message code="unsubscribe" /></h1>
            <input type="hidden" id="operator" value="1"/>
...
<div class="container">
		...
		<form id="frm-mobile-verification" onsubmit="return unsubscribe()">
			...
			<input  type="submit" class="btnSubmit" value="<spring:message code="unsubscribe" />">
		</form>
...
<script src="${context}/resources/javascript-files/unsub.js"></script>
</html>
